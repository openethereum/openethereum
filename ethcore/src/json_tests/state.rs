...
fn skip_test(test: &ethjson::test::StateTests, subname: &str, chain: &String, number: usize) -> bool {
...
pub fn json_chain_test<H: FnMut(&str, HookType)>(state_test: &ethjson::test::StateTests, path: &Path, json_data: &[u8], start_stop_hook: &mut H) -> Vec<String> {
