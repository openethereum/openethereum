...
fn rpc_parity_remove_transaction() {
    ...
    let request = r#"{"jsonrpc": "2.0", "method": "parity_removeTransaction", "params":[""#
        ...
        + &format!("0x{:x}", hash)
        + r#""], "id": 1}"#;
    let response = r#"{"jsonrpc":"2.0","result":{"accessList":[],"blockHash":null,"blockNumber":null,"chainId":null,"condition":null,"creates":null,"from":"0x0000000000000000000000000000000000000002","gas":"0x76c0","gasPrice":"0x9184e72a000","hash":"0x27f84e9fbb8838307b067b9669c34d099f80e5dd2d7da44fadc0ed074dadc5a4","input":"0x","nonce":"0x1","publicKey":null,"r":"0x1","raw":"0xe9018609184e72a0008276c0940000000000000000000000000000000000000005849184e72a801b0101","s":"0x1","standardV":"0x0","to":"0x0000000000000000000000000000000000000005","transactionIndex":null,"txType":128,"v":"0x1b","value":"0x9184e72a"},"id":1}"#;
